			...
			<div class="one">
				<div class="contact_enquiry_div">
					<h3>Send us your enquiry</h3>
										<form id="contact-us" class="form-horizontal" action="includes/send-mail-contact.php" method="post" novalidate="novalidate">
					  ...
					  <div class="form-group">
					    <label class="col-md-3 control-label">
					   	8 + 6 = ?<span></span>					   	</label>
					    <div class="col-md-9">
					      <input type="text" class="form-control" name="captcha" placeholder="" required="" data-msg-required="Please enter the result." aria-required="true">
					      <input type="hidden" name="hidden_value" value="14">
					    </div><!-- End .col-md-10 -->
					    <label class="captcha-label">(Give the answer and verify that you are a human)</label>
					  </div><!-- End . -->
